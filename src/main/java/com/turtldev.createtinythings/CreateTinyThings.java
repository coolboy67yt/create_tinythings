...
@Mod(CreateTinyThings.MODID)
public class CreateTinyThings
{
    // Define mod id in a common place for everything to reference
    public static final String MODID = "create_tinythings";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();
    // Create a Deferred Register to hold Blocks which will all be registered under the "create_tinythings" namespace
    public static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(MODID);
    // Create a Deferred Register to hold Items which will all be registered under the "create_tinythings" namespace
...
public static void registerBlockAndItemTextures() {
    ...
    public CreateTinyThings(IEventBus modEventBus, ModContainer modContainer)
    {
        ...
        // Note that this is necessary if and only if we want *this* class (CreateTinyThings) to respond directly to events.
